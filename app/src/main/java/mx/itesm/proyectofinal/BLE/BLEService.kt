...
class BLEService: Service() {
    ...
    private val TAG = "uuidBLE"
    private val mBinder: IBinder = LocalBinder()//Binder for Activity that binds to this Service
...
//            intent.putExtra(BLEConstants.EXTRA_DATA, (heartRate).toString())
...
//            val uuid = java.util.UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb")
...
// TODO IGUAL Y REGRESAR ESTO Y QUITAR LO DE ARRIBA
            for (des in characteristic.descriptors) {
